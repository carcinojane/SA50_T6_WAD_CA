	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			LeaveRecord lr1 = new LeaveRecord(1, LeaveStatus.APPLIED,"Japan holiday", 
					LocalDate.of(2020,7,13),'A', LocalDate.of(2020,7,17),'N',4,"staff2 will take over",97856210);
			...
			LeaveRecord lr2 = new LeaveRecord(1, LeaveStatus.APPLIED,"Off-in-lieu", 
					LocalDate.of(2020,8,3),'A', LocalDate.of(2020,8,3),'N',5,"staff1 will take over",88445544);
			...
			LeaveRecord lr3 = new LeaveRecord(1, LeaveStatus.APPLIED,"Broke arm on holiday", 
					LocalDate.of(2020,7,20),'A', LocalDate.of(2020,7,31),'N',4,"staff2 will take over",97856210);
			...
			LeaveRecord lr4 = new LeaveRecord(2, LeaveStatus.APPROVED,"Clearing leave", 
					LocalDate.of(2020,7,13),'A', LocalDate.of(2020,7,17),'N',6,"Manager 2 in charge",96223444);
			lr4.setLeaveType(LType.AnnualLeave);
			LeaveRecord lr5 = new LeaveRecord(1, LeaveStatus.APPROVED,"It's my birthday!",
					LocalDate.of(2020, 11, 9),'A',LocalDate.of(2020, 11, 9),'N',5,"Employee Perks",88445544);
